...
export default function Threads({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      const { color: liveColor, amplitude: liveAmplitude, distance: liveDistance, enableMouseInteraction: liveMouse } =
        propsRef.current;

      program.uniforms.uColor.value.set(...liveColor);
      program.uniforms.uAmplitude.value = liveAmplitude;
      program.uniforms.uDistance.value = liveDistance;
  ...
  return <div ref={containerRef} className={cn("h-full w-full", className)} {...rest} />;
}
